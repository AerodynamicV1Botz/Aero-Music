...
BOT_USERNAME = getenv("BOT_USERNAME", "Aero_MusicBot")
OWNER_USERNAME = getenv("OWNER_USERNAME", "")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "AerodynamicV1_Promotion")
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "240"))
START_IMG = getenv("START_IMG", "https://telegra.ph//file/c6d7af5a8dc30ea72764f.jpg")
PING_IMG = getenv("PING_IMG", "https://telegra.ph//file/c6d7af5a8dc30ea72764f.jpg")
